...
class BoT:
    def __init__(self, user_input,problems,model_name,device,model,tokenizer,bgeModel,output_templates,dic, CoT = False, ATP = False, GPT_CoT = False, one_shot = False):
